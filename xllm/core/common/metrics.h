...
DECLARE_HISTOGRAM(rec_pure_device_request_wait_latency_us);
DECLARE_HISTOGRAM(rec_pure_device_prepare_input_latency_us);
DECLARE_HISTOGRAM(rec_pure_device_d2h_latency_us);
DECLARE_HISTOGRAM(rec_pure_device_build_output_latency_us);
DECLARE_MULTI_HISTOGRAM(rec_pure_device_forward_latency_us);
DECLARE_MULTI_HISTOGRAM(rec_pure_device_logits_sampler_latency_us);
DECLARE_MULTI_HISTOGRAM(rec_pure_device_beam_search_latency_us);
DECLARE_MULTI_HISTOGRAM(rec_pure_device_update_input_latency_us);
